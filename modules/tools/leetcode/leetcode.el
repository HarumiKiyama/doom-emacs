...
;; Package-Requires: ((emacs "26") (dash "2.16.0") (graphql "0.1.1") (aio "1.0"))
;; Version: 0.1.10
...
(defun leetcode--login ()
  "fetch cookie and csrftoken from firefox cookie"
  (let* ((my-cookies (concat (executable-find "leetcode_cookies") " " leetcode--domain))
         (cookie-output (shell-command-to-string my-cookies))
         (cookies-list (seq-filter
                             (lambda (s) (not (string-empty-p s)))
                             (split-string cookie-output "\n")))
